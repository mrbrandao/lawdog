...
6. Informe os paths criados ao usuário:
   - `docs/`    — lawdog cria documentos da petição aqui
   - `anexos/`  — usuário coloca evidências aqui (qualquer formato)
   - `juntada/` — arquivos organizados para upload no PROJUDI
